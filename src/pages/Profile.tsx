      ...
      <div className="relative">
        ...
        <div className="px-6 -mt-12 mb-6">
          <div className="relative inline-block">
            ...
            {/* Fixed avatar upload label (was truncated) */}
            <label
              className="absolute bottom-0 right-0 w-10 h-10 bg-white text-primary rounded-full flex items-center justify-center shadow-lg cursor-pointer hover:scale-110 transition-transform z-10"
            >
            ...
            {profile.is_premium && (
              <div className="absolute bottom-0 right-0 translate-y-6 translate-x-[-2.25rem] bg-gradient-to-r from-amber-400 to-orange-500 text-white p-1.5 rounded-full border-[3px] border-background shadow-sm">
