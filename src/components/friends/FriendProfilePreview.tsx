...
const VerifiedBadge = () => (
  <svg 
    className="w-4 h-4 text-blue-500 flex-shrink-0 ml-1.5" 
    viewBox="0 0 22 22" 
    fill="currentColor"
    aria-label="Verified"
  >
  ...
  const { data: fullProfile, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const [profileRes, locationRes, premiumRes, subRes] = await Promise.all([
        ...
        // Check for active premium features
      ...
      return {
        ...
        isPremium: !!premiumRes.data || !!subRes.data
      };
    },
          ...
          <div className="flex flex-col items-center gap-4 py-4">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center">
                ...
                {fullProfile.isPremium && <VerifiedBadge />}
              </div>
              {fullProfile.bio && (
